...
const nautilusBacktestRoutes = require('./routes/nautilusBacktest.routes');
const botBacktestRoutes = require('./routes/botBacktest.routes');
const changelogRoutes = require('./routes/changelog.routes');
const struggleCalibrationRoutes = require('./routes/struggleCalibration.routes');
...
app.use('/api/nautilus-backtest', nautilusBacktestRoutes);
app.use('/api/bot-backtest', botBacktestRoutes);
app.use('/api/changelog', changelogRoutes);
app.use('/api/struggle-calibration', struggleCalibrationRoutes);
